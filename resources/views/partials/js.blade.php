...
<script src="{{ asset('js/tinysort.charorder.js') }}"></script>


<script type="text/javascript" src="{{ asset('js/select2.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('js/slick.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('js/calcs.js') }}"></script>
...
<script src="{{ asset('js/flot/jquery.flot.symbol.js') }}" type="text/javascript"></script>
<script src="{{ asset('js/flot/jquery.flot.time.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('js/flot/jquery.flot.crosshair.min.js') }}" type="text/javascript"></script>
