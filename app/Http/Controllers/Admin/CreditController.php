    ...
    public function store(Request $request, $id = null)
    {
        if (!$request->ajax()) {
            ...
            $credit_arr = [
                ...
                'have_work_phone'  => $request->have_work_phone ?? false,
                ...
                'receive_mode'  => json_encode($request->receive_mode),
    ...
    //                    'created_by',
                    ...
                    if(isset($credit_props_input['credit_fees'][$key])){
                        ...
                        foreach ($credit_props_input['credit_fees'][$key] as $fee_inner) {
                            ...
                            $fee_inner['credit_id'] = $credit->id;
                            $fee_inner['credit_prop_id'] = $credit_prop->id;

                            if($fee_inner['fee_id'] == null){
                                $fee_inner['created_by'] = Auth::id();
                            }
